...
# Gestisce l'export degli utenti privati da backoffice

module Decidim
  module Pua
    module Admin
      class ExportsController < Decidim::Pua::Admin::ApplicationController
        ...
        def index
          ...
          UserExportJob.perform_now(current_user, current_participatory_process, 'decidim_pua_users', 'CSV')
